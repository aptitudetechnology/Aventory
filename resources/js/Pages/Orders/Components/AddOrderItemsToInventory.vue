        ...
        <form @submit.prevent="addInventory" @keydown.enter="addInventory">
          <div class="col-span-6 grid gap-6 divide-gray-100 divide-y">
            ...
            <div v-if="!selectedNursery" class="pt-6">
              ...
              <p class="mt-1 text-sm text-gray-500">
                Select which nursery these plants will be located in.
              </p>
              <RadioGroup v-model="selectedNursery" class="mt-4">
                <RadioGroupLabel class="sr-only">
                  Nursery Location
                </RadioGroupLabel>
                <JetInputError :message="form.errors.nursery_location_id" />
                <div class="bg-white rounded-md -space-y-px">
                  <RadioGroupOption
                    as="template"
            ...
            <div v-if="selectedNursery" class="py-4">
              <back-button @click="selectedNursery = null" class="mb-4"
