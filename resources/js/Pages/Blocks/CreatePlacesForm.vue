<template>
  <div>
    ...
    <jet-dialog-modal :show="creatingPlaces" @close="creatingPlaces = false">
      ...
      <template #content>
        <form @submit.prevent="createPlaces" @keyup.enter="createPlaces">
          <div class="col-span-6">
            <div class="grid gap-4">
              <div class="col-span-4 sm:col-span-2">
                <jet-label for="num_rows" value="Number of Rows" />
                <jet-input
                  id="num_rows"
                  type="number"
                  ...
                  autocomplete="off"
                />
                <jet-input-error :message="form.errors.num_rows" class="mt-2" />
              </div>
              <div class="col-span-4 sm:col-span-2">
                <jet-label for="starting_row_num" value="Starting Row Number" />
                <jet-input
                  id="starting_row_num"
                  type="number"
                  class="mt-1 block w-full"
              ...
              <div class="col-span-4 sm:col-span-2">
                <jet-label for="num_plants_per_row" value="Plants Per Row" />
                <jet-input
