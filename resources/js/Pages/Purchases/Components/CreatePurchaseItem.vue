<template>
    <div>
        ...
        >
        <jet-dialog-modal
            :show="creatingPurchaseItem"
            @close="creatingPurchaseItem = false"
        >
            <template #title>Add an purchase item.</template>

            <template #description>
                Add a new purchase item. Then, you can add this item to
                inventory and print tags.
            </template>

            <template #content>
                <form
                    @submit.prevent="createPurchaseItem"
                    @keydown.enter="createPurchaseItem"
                >
            ...
            <template #footer>
                <div class="flex justify-between items-center w-full">
                    <jet-secondary-button
                        type="button"
                        @click="creatingPurchaseItem = false"
                        >Cancel</jet-secondary-button
                    >
                    <div>
                        <jet-button
                            type="submit"
                            @click="createPurchaseItem"
                            :class="[
