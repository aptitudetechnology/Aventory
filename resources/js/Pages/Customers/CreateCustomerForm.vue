<template>
  <div>
    <form
      ...
      class="py-8 space-y-8 divide-y divide-gray-200"
    >
        ...
        >
          <span class="flex-grow flex flex-col">
            ...
            <SwitchDescription as="span" class="text-sm text-gray-500"
              >Indicate whether the mailing address of this customer is the same
      ...
      <div class="grid gap-4">
        ...
        <div class="col-span-3 sm:col-span-1">
          ...
          <jet-input-error :message="form.errors.tax_percentage" class="mt-2" />
        </div>
        <div class="col-span-3 sm:col-span-1">
      ...
      <jet-button type="submit" class="sm:col-span-1 mt-4"
