<template>
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                ...
                <template #description>
                    Add a new team member to your account, allowing them to
        ...
        >
            ...
            <!-- Company Team Member Invitations -->
            <jet-action-section class="mt-10 sm:mt-0">
                ...
                <!-- Pending Company Team Member Invitation List -->
                <template #content>
                    <div class="space-y-6">
                        <div
        ...
        <div v-if="team.users.length > 0">
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                <template #title> Company Team Members </template>

                <template #description>
                    All of the people that are part of this team.
                </template>

                <!-- Company Team Member List -->
                <template #content>
                    <div class="space-y-6">
                        <div
                            class="flex items-center justify-between"
                        ...
                        >
                            ...
                            <div class="flex items-center">
                                <!-- Manage Company Team Member Role -->
                                <button
        ...
        <!-- Remove Company Team Member Confirmation Modal -->
        <jet-confirmation-modal
            :show="teamMemberBeingRemoved"
            @close="teamMemberBeingRemoved = null"
        >
            <template #title> Remove Company Team Member </template>
